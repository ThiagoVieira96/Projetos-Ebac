...
def main():
    ...
    # URL do arquivo
    data_url = 'https://raw.githubusercontent.com/ThiagoVieira96/Projetos-Ebac/main/Modulo%20Streamlit%204/dados_test_input%202.csv'

    # Carregar dados diretamente do URL
    df_compras = pd.read_csv(data_url, infer_datetime_format=True, parse_dates=['DiaCompra'])
    
    # Conteúdo da barra lateral
    st.sidebar.header("Projeto RFV")
    st.sidebar.write("""
    Esta aplicação realiza segmentação de clientes usando a técnica RFV.
    O arquivo de dados utilizado pode ser encontrado [aqui](https://raw.githubusercontent.com/ThiagoVieira96/Projetos-Ebac/main/Modulo%20Streamlit%204/dados_test_input%202.csv).
    """)
